...
const LandingPage = () => {
    ...
    return (
        <div className="landing-page">
            ...
            {/* Redesigned Orchestration with Timing Traces */}
            <TracingSection />
...
// Impact Graph with Left Panel and Fixed Ball
                ...
                <div className="impact-graph-split">
                    ...
                    >
                        <svg className="graph-svg" viewBox="0 0 900 400" preserveAspectRatio="xMidYMid meet">
                            ...
                            {/* Unoptimized line - draws on scroll into view */}
                            <motion.path
                            ...
                            {/* Ball at end of unoptimized line */}
                            <motion.circle
                                cx="820"
                                cy="230"
                                r="6"
                            ...
                            {/* Optimized line - controlled by mouse */}
                            <motion.path
                            ...
                            {/* Ball at END of optimized line only */}
                            <motion.circle
                                cx="820"
                                cy="45"
                                r="7"
...
// New Tracing Section (like image 5)
